...
- the R-W3 Windows target still uses systemd as the outer WSL launcher supervisor; native Windows child identity is separate evidence, and WSL-restart-independent reconciliation is not yet claimed.
